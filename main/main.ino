...
// Actuator Setup ActuatorModule(PUMP_PIN,FAN_PIN,LIGHT_PIN)
ActuatorModule actuator(PUMP_PIN, FAN_PIN_1, FAN_PIN_2, LIGHT_PIN);
...
void evaluateSensorsAndTrigger() {
  ...
  bool lightBelow = sensor.checkAndTrigger("Light", lightValue, lightMax);
  bool airQualityBelow = sensor.checkAndTrigger("Air Quality", airQualityValue, airQualityMax);
  bool tempBelow= sensor.checkAndTrigger("Temperature", tempValue, tempMax);
